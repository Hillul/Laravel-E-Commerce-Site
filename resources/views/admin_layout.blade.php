...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<!-- all categoty -->
						<li><a href="{{URL::to('/all-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet">All Category</span></a></li>
						<!-- add category -->	
						...
						<li><a href="{{URL::to('/add-manufacture')}}"><i class="icon-tasks"></i><span class="hidden-tablet">Add Manufacture</span></a></li>
	...
	<!-- start: JavaScript-->
		...
		<script src="{{asset('backend/js/jquery.dataTables.min.j')}}s"></script>
